...
export const SONG_NOT_FOUNDED = new ErrorCodeVo(404, 'SONG_NOT_FOUNDED', '해당 노래가 발견되지 않았습니다.');
export const PROFILE_NOT_FOUNDED = new ErrorCodeVo(404, 'PROFILE_NOT_FOUNDED', '해당 프로필이 발견되지 않았습니다.');
export const TAG_NAME_NOT_FOUNDED = new ErrorCodeVo(404, 'TAG_NAME_NOT_FOUNDED', '해당 태그 이름이 발견되지 않았습니다.');
export const REFRESH_TOKEN_NOT_FOUND = new ErrorCodeVo(404, 'REFRESH_TOKEN_NOT_FOUND', '해당 id의 refresh token이 발견되지 않았습니다.');
export const PATTERN_NOT_FOUND = new ErrorCodeVo(404, 'PATTERN_NOT_FOUND', '해당 Pattern이 발견되지 않았습니다.');
export const EMAIL_ALREADY_EXISTS = new ErrorCodeVo(409, 'EMAIL_ALREADY_EXISTS', '이미 사용 중인 이메일입니다.');
export const SONG_TITLE_ALREADY_EXISTS = new ErrorCodeVo(409, 'SONG_TITLE_ALREADY_EXISTS', '동일한 제목의 노래가 이미 존재합니다.');
export const TAG_NAME_ALREADY_EXISTS = new ErrorCodeVo(409, 'TAG_NAME_ALREADY_EXISTS', '동일한 태그 이름이 이미 존재합니다.');
export const PATTERN_ALREADY_EXISTS = new ErrorCodeVo(409, 'PATTERN_ALREADY_EXISTS', '곡/난이도/DX여부가 동일한 패턴이 이미 존재합니다.');