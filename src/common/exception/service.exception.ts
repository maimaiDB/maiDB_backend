...
export const PatternNotFoundedException = (message?: string): ServiceException => {
    return new ServiceException(PATTERN_NOT_FOUND, message);
}
...
export const PatternAlreadyExistsException = (message?: string): ServiceException => {
    return new ServiceException(PATTERN_ALREADY_EXISTS, message);
}